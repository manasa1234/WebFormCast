      ...
      <div class="bcru"><a href="cases.aspx">Cases</a> &raquo; <a href="home.aspx"><asp:Label ID="lbCompanyName" runat="server"></asp:Label></a> &raquo; <a href="employeeview.aspx"><asp:Label ID="lbtrackingno" runat="server"></asp:Label></a> &raquo; Form - G28</div>
       <div id="whiteArea">
           <div id="dropdown" runat="server">
             <h2>  Please select the Visa Type from the drop down list to retrieve the template </h2>
               <br />
             Visa Type:  <asp:DropDownList ID="ddvisatype" runat="server" OnSelectedIndexChanged="ddvisatype_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
           </div>
           <div id="tmp" runat="server">
      <table width="100%"   style="border:0px" cellspacing="0" cellpadding="0">
        <tr><td style="border:0px" class="auto-style1"><h2><asp:Label ID="lbTemplate" runat="server"></asp:Label></h2></td>
            <td style="border:0px" align="right" valign="top" width="50%">
                <asp:Button ID="hlDelete" Text="Delete" Font-Bold="true" NavigateUrl="templatedit.aspx" runat="server" OnClick="hlDelete_Click"></asp:Button>
                                &nbsp;&nbsp;&nbsp;&nbsp;
               <%-- <asp:HyperLink id="hlEdit" Text="Edit" Font-Bold="true" NavigateUrl="templatedit.aspx" runat="server"></asp:HyperLink>
                                &nbsp;&nbsp;&nbsp;&nbsp;--%>
                              <asp:Button ID="hlEdit" Text="Edit" Font-Bold="true" runat="server" OnClick="hlEdit_Click">  </asp:Button>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="hlDownloadPdf" runat="server" Font-Bold="True" Text="Download PDF" OnClick="hlDownloadPdf_Click"></asp:Button> </td></tr>
      </table>
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr><td><asp:Label ID="lbTemplatebody" runat="server" ></asp:Label></td></tr>
           <tr><td>  <asp:TextBox ID="txtTemplateBody" runat="server" TextMode="MultiLine"   Height="466px" Width="904px" visible="false"></asp:TextBox></td></tr><br />
        </table>
