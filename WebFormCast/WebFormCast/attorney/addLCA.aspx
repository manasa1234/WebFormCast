                ...
                <table border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button ID="lcasearch" Text="Find LCA" runat="server"  OnClick="lcasearch_Click" CausesValidation="false" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <div class="title">
                                    Add New LCA Information
                                </div>
                                <div class="bcru">
                                    <a href="lca.aspx">LCA</a> &raquo; Add LCA
                                </div>
                                <div id="whiteArea">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        <td class="style1">Tracking ID:
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="RlTrack" runat="server" AutoPostBack="True" Style="font-family: Verdana; font-size: small"
                                                                DataSourceID="SqlDataSource2" DataTextField="Tracking_No" DataValueField="Employee_Id"
                                                    ...
                                                    <tr>
                                                        <td class="style1">LCA Track Number:
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="style1">Employment Start Date
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="style1">Employment End&nbsp; Date
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="style1">Date of Action
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="style1">Current Status
                                                        </td>
                                                        <td>
