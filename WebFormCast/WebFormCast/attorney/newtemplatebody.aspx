<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newtemplatebody.aspx.cs" Inherits="WebFormCast.attorney.newtemplatebody" %>
...
<div id="container">
  ...
  <asp:Label ID="lbNavigation" runat="server">
    ...
    <div id="contentArea4">
              ...
              <tr>
                ...
                <td align="left" class="topbar_sub_bg">
                    ...
                    <tr>
                      ...
                      <td>&raquo; <a href="templatebody.aspx"> TemplateBody</a></td>
      ...
      <div class="bcru"><a href="templates.aspx">Templates</a> &raquo; <a href="templatebody.aspx">Template Body</a> &raquo;Create New TemplateBody</div>
      <div id="whiteArea">
        <table width="100%" style="border-left:1px solid #CCCCCC;border-top:1px solid #CCCCCC;" border="0" cellspacing="0" cellpadding="5">
           ...
           <tr>
            <td style="border-right:1px solid #CCCCCC;border-bottom:1px solid #CCCCCC;" valign="middle">Visa Type:<asp:DropDownList ID="ddVisaType" runat="server" Height="16px" AutoPostBack="true" CssClass="input_edit" onselectedindexchanged="ddVisaType_SelectedIndexChanged"></asp:DropDownList></td>
            <td style="border-right:1px solid #CCCCCC;border-bottom:1px solid #CCCCCC;" valign="middle">Template Name:
                <asp:DropDownList ID="ddTemplates" runat="server"  AutoPostBack="true" onselectedindexchanged="ddTemplates_SelectedIndexChanged" AppendDataBoundItems="true" >
             
                </asp:DropDownList> 
                <asp:TextBox ID="txtother" Visible="false" runat="server" Height="16px" OnTextChanged="txtother__Leave" ></asp:TextBox>
            </td>
               <td></td>
           </tr>
          <tr>
          ...
          <tr><td style="border-right:1px solid #CCCCCC;border-bottom:1px solid #CCCCCC;" colspan="3"><asp:Button ID="btnSave" runat="server" Text="Save" 
            ...
            &nbsp;&nbsp;<asp:Button ID="btnDelete" runat="server" Text="Delete" OnClick="btnDelete_Click" Visible="False" /></td></tr>
        </table>
      </div>
    </div>
  </div>
