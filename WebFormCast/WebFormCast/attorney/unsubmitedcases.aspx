<%@ Page Language="C#" AutoEventWireup="true" Inherits="unsubmitedcases" Codebehind="unsubmitedcases.aspx.cs" %>
...
<div id="container">
  ...
  <div id="contentShadows">
    <asp:Label ID="lbNavigation" runat="server"><ul class="topNav">
      ...
      <li><a href="cases.aspx"><b>Cases</b></a></li><a href="unsubmitedcases.aspx">unsubmitedcases.aspx</a>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <div class="title">Client Un-Approved Cases</div>
      <div class="bcru"><a href="home.aspx">Home</a> &raquo; Client Un-Approved Cases</div>
      <div id="whiteArea">
        <b>Client Name:</b> <asp:DropDownList ID="ddUnApprovedClients" runat="server" 
              AutoPostBack="True" 
              onselectedindexchanged="ddUnApprovedClients_SelectedIndexChanged"></asp:DropDownList><br />
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="Employee_id,Employee_Code,Tracking_No" DataNavigateUrlFormatString="#" DataTextField="FullName" HeaderText="Employee Name"/>
