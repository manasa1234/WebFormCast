<%@ Page Language="C#" AutoEventWireup="true" Inherits="attorney_employeeview" CodeBehind="employeeview.aspx.cs" %>
    ...
    <li><a href="home.aspx"><b>Home</b></a></li>
      ...
      <li><a href="myaccount.aspx"><b>My Account</b></a></li>
                ...
                <div id="contentArea1">
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" class="topbar_sub_bg">Clients
                                            <asp:DropDownList
                                                ...
                                                OnSelectedIndexChanged="ddEmployer_SelectedIndexChanged">
                                            </asp:DropDownList><br />
                                            <br />
                                            Search.
                                            <asp:TextBox ID="txtTrackingNo" runat="server" Width="160px"
                    ...
                    <div class="bcru">
                        <a href="cases.aspx">Cases</a> &raquo; <a href="home.aspx">
                            <asp:Label ID="lbCompanyName" runat="server"></asp:Label></a> &raquo; <a href="employeeview.aspx">
                                <asp:Label ID="lbtrackingno" runat="server"></asp:Label></a>
                    </div>
                    <div id="whiteArea">
                ...
                <br />
                    ...
                    <div class="whiteArea">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>LCA Case Number</td>
                                <td>
                                    <asp:TextBox ID="txtLCANo" runat="server"></asp:TextBox></td>
                                <td>NAICS Code</td>
                                <td>
                                    <asp:TextBox ID="txtNAICS" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>Other Compensation</td>
                                <td colspan="3">
                                    <asp:TextBox TextMode="MultiLine" Rows="4" Columns="100" ID="txtOtherCompensation" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>Alien's present occupation and summary of prior work experience</td>
                                <td colspan="3">
                                    <asp:TextBox ID="txtWorkExperience" TextMode="MultiLine" Rows="5" Columns="120" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
            ...
            <input type="text" maxlength="10" id="txtDateIntendedTo" runat="server" />&nbsp;<a href="#" id="f_DateIntendedTo"><img src="../images/icon_calender.jpg" alt="" width="14" height="14" border="0" align="absmiddle" /></a></td>
                ...
                <asp:TextBox ID="txtWagsperYear" runat="server" Width="55px"></asp:TextBox>
                        ...
                        <div class="divBlock" align="center">
                            <asp:Button ID="btnAccept" Text="Accept And Fill Forms"
                                runat="server" OnClick="btnAccept_Click" />&nbsp;&nbsp;&nbsp;
