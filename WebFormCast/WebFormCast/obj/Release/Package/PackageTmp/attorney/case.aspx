...
<div id="container">
  ...
  <asp:Label ID="lbNavigation" runat="server">
              ...
              <tr>
                ...
                <td align="right" class="topbar_sub_bg">Clients <asp:DropDownList 
                        AutoPostBack="true" ID="ddEmployer" style="width:200px" runat="server" 
                         EnableViewState="true" OnSelectedIndexChanged="ddEmployer_SelectedIndexChanged" ></asp:DropDownList><br /><br />
                  Search. <asp:TextBox ID="txtTrackingNo" runat="server" Width="160px" OnTextChanged="txtTrackingNo_TextChanged"></asp:TextBox>&nbsp;<asp:Button 
    ...
    <tr>
            ...
            <td align="left"><asp:DropDownList AutoPostBack=true  id="dlClient" runat="server" OnSelectedIndexChanged="dlClient_SelectedIndexChanged"></asp:DropDownList></td>
            <td align="right">Tracking No</td>
            <td align="left">&nbsp;<asp:label Font-Bold="true" ReadOnly="true" ID="txtTrackingId" runat="server"/></td>
            <td align="right">Type</td>
            <td align="left"><asp:DropDownList ID="ddType" runat="server" OnSelectedIndexChanged="ddType_SelectedIndexChanged"></asp:DropDownList><asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="ddType" runat="server" ErrorMessage="*" InitialValue="0" Display="Dynamic"></asp:RequiredFieldValidator>
    ...
    <tr>
            ...
            <td  id="rowAssign" align="left" colspan="3">&nbsp;<asp:DropDownList ID="ddUsers" runat="server" OnSelectedIndexChanged="ddUsers_SelectedIndexChanged"></asp:DropDownList></td>
     </tr>
     <tr>
    ...
    <tr>
        <td colspan="2" align="center"><asp:Button ID="btnCancel" CausesValidation="false"  runat="server" Text="Cancel" OnClick="btnCancel_Click" />&nbsp;&nbsp;&nbsp; <asp:Button ID="btnUpdate" runat="server" Text="Update" OnClick="btnUpdate_Click" /></td></tr>
    <tr>
    <td colspan="2">
