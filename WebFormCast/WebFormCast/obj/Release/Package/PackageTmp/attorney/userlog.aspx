<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userlog.aspx.cs" Inherits="WebFormCast.attorney.userlog" %>
...
<div id="header">
  ...
  <asp:Label ID="lbNavigation" runat="server">
    ...
    <li><a href="home.aspx"><b>Home</b></a></li>
      ...
      <li class="current"><a href="useraccounts.aspx"><b>User Accounts</b></a></li><a href="userlog.aspx">userlog.aspx</a>
        ...
        <tr>
          ...
          <td class="topbar_bg"><table border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td align="right" class="topbar_sub_bg">User :<asp:DropDownList ID="ddUsers" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddUsers_SelectedIndexChanged"></asp:DropDownList></td>
