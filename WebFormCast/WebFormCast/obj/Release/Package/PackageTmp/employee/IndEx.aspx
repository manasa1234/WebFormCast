<%@ Page Language="C#" AutoEventWireup="true" EnableViewStateMac="false" Inherits="employee_login" Codebehind="index.aspx.cs" %>
...
<div id="container">
  <div id="header">
  <div id="headerlogo"><asp:Label ID="lbCompanyLogoText" Text="Welcome to Immigration Management System"  runat="server"></asp:Label><!--<img src="../images/logo.gif" width="160" height="45" />--></div>  
        ...
        <table width="210" border="0" cellspacing="0" cellpadding="0" style="border:0">
          <tr>
            <td style="border:0; padding:10px; background-image:url(../images/login_bg.gif)"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:0">
              ...
              <tr>
                <td style="border:0" align="center"><asp:TextBox ID="txtEmail" runat="server"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtEmail" Display="Dynamic" ErrorMessage="required" runat="server"></asp:RequiredFieldValidator></td>
              </tr>
              <tr>
                <td style="border:0; font-weight:bold; font-size:12px; color:#43576c" align="center">Password</td>
              </tr>
              <tr>
                <td style="border:0" align="center"><asp:TextBox ID="txtPassword" TextMode="Password"  runat="server"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2"  Display="Dynamic" ControlToValidate="txtPassword" runat="server" ErrorMessage="required"></asp:RequiredFieldValidator></td>
              </tr>
              <!--
              <tr>
          ...
          <tr>
            <td style="border:0; padding:0">
                    ...
                    onclick="btnSubmit_Click" ImageUrl="../images/login_btn.gif" Width="210" Height="41"  />
                    </td>
          </tr>
        </table>
        </form>
